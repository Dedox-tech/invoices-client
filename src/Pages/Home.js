...
export default function Home() {
    return (
        <Box sx={{ display: "flex", justifyContent: "center", alignItems: "start", backgroundColor: "#fff1d7", height: "fill" }}>
            <Grid container sx={{ mt: 10 }}>
                <Grid item xs={5}>
                    <Container sx={{ ml: 5, mb: 5 }}>
                        <h2>La app que se encarga de tus facturas</h2>
                        <p>Administrar el dinero puede ser complicado. No lo hagas solo. Nuestra app te ayudará a ahorrar más, gastar menos, ver todos tus movimientos y tomar el control de tu vida financiera.</p>
